...
<img src="figures/fig-01-identifier-vs-address.svg" alt="Phone number resolving down through subscriber, network, location and radio identity to a device" width="420">
...
<img src="figures/fig-02-e164-structure.svg" alt="+91 98XX YYYYYY split into country calling code and national subscriber numbering space" width="330">
...
<img src="figures/fig-03-identity-family.svg" alt="Telephony identities: MSISDN, IMSI, SIM/UICC and IMEI" width="250">

Underneath, the machinery was rebuilt three times while the numbering plan barely moved:

<img src="figures/fig-04-switching-evolution.svg" alt="Physical switching to digital circuit network to software-defined telecom" width="275">
...
<img src="figures/fig-05-call-sequence.svg" alt="The complete call sequence from pre-call registration through INVITE, paging, answer, RTP and release" width="700">
...
<img src="figures/fig-06-packet-stack.svg" alt="Application, transport, network and radio layers of the packet stack" width="340">
<img src="figures/fig-07-encapsulation-gtpu.svg" alt="GTP-U over UDP over IP encapsulation stack" width="250">

That progressive discarding of meaning is the architecture's central trick:

<img src="figures/fig-08-loss-of-meaning.svg" alt="Semantic layer to network layer to physical layer, meaning discarded at each step" width="250">
...
<img src="figures/fig-09-intent-to-eardrum.svg" alt="From human intent through number resolution, SIP, RTP, the radio stack, to a pressure wave at the ear" width="700">
...
figures/    the nine figures used above, as standalone SVG
